...
void ACombatCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindAxis("TurnRate", this, &ACombatCharacter::TurnAtRate);
	PlayerInputComponent->BindAxis("LookUp", this, &APawn::AddControllerPitchInput);
	PlayerInputComponent->BindAxis("LookUpRate", this, &ACombatCharacter::LookUpAtRate);
	...
	PlayerInputComponent->BindAction("ResetVR", IE_Pressed, this, &ACombatCharacter::OnResetVR);
}


void ACombatCharacter::OnResetVR()
{
	// If Combat is added to a project via 'Add Feature' in the Unreal Editor the dependency on HeadMountedDisplay in Combat.Build.cs is not automatically propagated
